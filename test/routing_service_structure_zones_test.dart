...
void main() {
  ...
  group('B — 임계값 미만 구간은 제외', () {
    test('합산 길이 100m 미만인 bridge run → zone 0개', () {
      final edges = <dynamic>[
        edge(bridge: true, beginShapeIndex: 0, endShapeIndex: 1, length: 0.03),
        edge(bridge: true, beginShapeIndex: 1, endShapeIndex: 2, length: 0.02),
      ];
